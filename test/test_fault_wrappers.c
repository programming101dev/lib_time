...
static void test_p101_clock_getres(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            {
                fprintf(stderr, "native smoke failed: p101_clock_getres: %s\n", p101_error_get_message(native_err));
                native_passed = false;
            }
...
static void test_p101_clock_gettime(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            if(p101_error_has_error(native_err))
            {
                fprintf(stderr, "native smoke failed: p101_clock_gettime: %s\n", p101_error_get_message(native_err));
                native_passed = false;
            }
            native_child_status = native_passed ? EXIT_SUCCESS : EXIT_FAILURE;
        native_child_done_:
...
static void test_p101_clock_settime(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            if(p101_error_has_error(native_err))
            {
                fprintf(stderr, "native smoke failed: p101_clock_settime: %s\n", p101_error_get_message(native_err));
                native_passed = false;
            }
            native_child_status = native_passed ? EXIT_SUCCESS : EXIT_FAILURE;
        native_child_done_:
...
static void test_p101_gmtime_r(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            if(p101_error_has_error(native_err))
            {
                fprintf(stderr, "native smoke failed: p101_gmtime_r: %s\n", p101_error_get_message(native_err));
                native_passed = false;
            }
            native_child_status = native_passed ? EXIT_SUCCESS : EXIT_FAILURE;
        native_child_done_:
...
static void test_p101_localtime_r(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            if(p101_error_has_error(native_err))
            {
                fprintf(stderr, "native smoke failed: p101_localtime_r: %s\n", p101_error_get_message(native_err));
                native_passed = false;
            }
            native_child_status = native_passed ? EXIT_SUCCESS : EXIT_FAILURE;
        native_child_done_:
...
static void test_p101_nanosleep(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            if(p101_error_has_error(native_err))
            {
                fprintf(stderr, "native smoke failed: p101_nanosleep: %s\n", p101_error_get_message(native_err));
                native_passed = false;
            }
            native_child_status = native_passed ? EXIT_SUCCESS : EXIT_FAILURE;
        native_child_done_:
...
static void test_p101_strftime_l(struct p101_env *env, struct p101_error *err)
{
    ...
    p101_env_set_fault_injector(env, NULL, NULL);
    {
        ...
        if(native_pid == 0)
        {
            ...
            if(p101_error_has_error(native_err))
            {
                fprintf(stderr, "native smoke failed: p101_strftime_l: %s\n", p101_error_get_message(native_err));
                native_passed = false;
            }
